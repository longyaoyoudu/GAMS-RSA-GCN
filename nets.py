...
##########################################
from .AA_CA_l1 import STA_GC
#from .AA_CA_ln2 import STA_GC


class STAGCN(nn.Module):        ###   kernel_size=[3 2] 在configs文件夹中
    def __init__(self, data_shape, kernel_size, A, **kwargs):   #####（**kwargs）传参作用  通过关键‘A’字传参
